...
#SBATCH -o /home/jguven/projects/metalloenzymes/dft/slurm_logs/bonded_md.%A.%a.slurm.out
#SBATCH -e /home/jguven/projects/metalloenzymes/dft/slurm_logs/bonded_md.%A.%a.slurm.err
...
#SBATCH --mem 4096
# set job name
#SBATCH --job-name=bonded_md



run_dir=$HOME/projects/metalloenzymes/dft/ligand_/amber/
