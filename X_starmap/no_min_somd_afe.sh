...
#	min_dir=$HOME/projects/metalloenzymes/starmap/outputs/with_min/${engine}_1/$lig_1~$lig_2/$stage/minimisation/lambda_$lambda
	lambda_dir=$HOME/projects/metalloenzymes/starmap/outputs/no_min/${engine}_1/$lig_1~$lig_2/$stage/lambda_$lambda
