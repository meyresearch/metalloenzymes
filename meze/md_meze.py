...
def run_md(ligand_name):
    minimised_system = minimisation_0(ligand_name)
    equilibrated_system = equilibration_0(ligand_name, minimised_system)
    production(ligand_name, equilibrated_system)