...
#SBATCH -o /home/jguven/projects/metalloenzymes/slurm_logs/somd2_afe.%A.%a.slurm.out
#SBATCH -e /home/jguven/projects/metalloenzymes//slurm_logs/somd2_afe.%A.%a.slurm.err
...
do
    	...
    	min_dir=$HOME/projects/alchemistry/kpc2_deprotonated_ligand/outputs/${engine}_2/$lig_1~$lig_2/$stage/minimisation/lambda_$lambda
    	echo $min_dir
    	lambda_dir=$HOME/projects/alchemistry/kpc2_deprotonated_ligand/outputs/${engine}_2/$lig_1~$lig_2/$stage/lambda_$lambda
