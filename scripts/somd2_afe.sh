...
do
    	...
    	min_dir=$HOME/projects/metalloenzymes/vim_2/outputs/${engine}_2/$lig_1~$lig_2/$stage/minimisation/lambda_$lambda
    	echo $min_dir
    	lambda_dir=$HOME/projects/metalloenzymes/vim_2/outputs/${engine}_2/$lig_1~$lig_2/$stage/lambda_$lambda
