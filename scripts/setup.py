...
transformations, lomap_scores = bss.Align.generateNetwork(ligands, plot_network=False, names=ligand_names, work_dir=ligand_path) # Change plot_network=True when fixed!
