...
#	echo "Second minimisation complete."
	...
	cd bb_r_nvt
	gmx grompp -f bb_r_nvt.mdp -c bb_r_nvt.gro -r bb_r_nvt.gro -t ../r_nvt/r_nvt.cpt -p bb_r_nvt.top -o bb_r_nvt.tpr -maxwarn 1
	...
	cd nvt
	gmx grompp -f nvt.mdp -c nvt.gro -t ../bb_r_nvt/bb_r_nvt.cpt -p nvt.top -o nvt.tpr -maxwarn 1
