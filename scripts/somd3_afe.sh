...
do
    	...
    	min_dir=$HOME/projects/metalloenzymes/azetidinimines/kpc2/outputs/${engine}_3/$lig_1~$lig_2/$stage/minimisation/lambda_$lambda
    	echo $min_dir
    	lambda_dir=$HOME/projects/metalloenzymes/azetidinimines/kpc2/outputs/${engine}_3/$lig_1~$lig_2/$stage/lambda_$lambda
