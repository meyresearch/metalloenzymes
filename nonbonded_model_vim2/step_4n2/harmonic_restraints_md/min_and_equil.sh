...
$AMBERHOME/bin/pmemd.cuda -O -i 1min.in\
            -o 1min.out -p $input_dir/vim2_solv.prmtop -c $input_dir/vim2_solv.inpcrd -r 1min.rst7\
            -inf 1min.info -ref $input_dir/vim2_solv.inpcrd -x mdcrd.1min
echo "ending 1min at $date"
wait
echo "starting 2mdheat at $date"

$AMBERHOME/bin/pmemd.cuda -O -i 2mdheat.in\
            -o 2mdheat.out -p $input_dir/vim2_solv.prmtop -c 1min.rst7 -r 2mdheat.rst7\
...
$AMBERHOME/bin/pmemd.cuda -O -i 3md.in\
            -o 3md.out -p $input_dir/vim2_solv.prmtop -c 2mdheat.rst7 -r 3md.rst7\
...
$AMBERHOME/bin/pmemd.cuda -O -i 4md.in\
            -o 4md.out -p $input_dir/vim2_solv.prmtop -c 3md.rst7 -r 4md.rst7\
...
$AMBERHOME/bin/pmemd.cuda -O -i 5min.in\
            -o 5min.out -p $input_dir/vim2_solv.prmtop -c 4md.rst7 -r 5min.rst7\
...
$AMBERHOME/bin/pmemd.cuda -O -i 6md.in\
            -o 6md.out -p $input_dir/vim2_solv.prmtop -c 5min.rst7 -r 6md.rst7\
...
$AMBERHOME/bin/pmemd.cuda -O -i 7md.in\
            -o 7md.out -p $input_dir/vim2_solv.prmtop -c 6md.rst7 -r 7md.rst7\
...
$AMBERHOME/bin/pmemd.cuda -O -i 8md.in\
            -o 8md.out -p $input_dir/vim2_solv.prmtop -c 7md.rst7 -r 8md.rst7\
...
$AMBERHOME/bin/pmemd.cuda -O -i 9md.in\
            -o 9md.out -p $input_dir/vim2_solv.prmtop -c 8md.rst7 -r 9md.rst7\
